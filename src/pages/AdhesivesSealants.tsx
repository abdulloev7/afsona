      ...
      <main className="flex-1 py-16">
        <div className="container mx-auto px-4">
          <div className="mb-8">
            ...
            <h1 className="text-4xl font-bold mb-4">Клеи, герметики и монтажные материалы</h1>
            <p className="text-muted-foreground text-lg">
              Профессиональные клеи и герметики для различных задач
            </p>
          </div>
...
export default AdhesivesSealants;
