      ...
      <main className="flex-1 py-16">
        <div className="container mx-auto px-4">
          <div className="mb-8">
            ...
            <h1 className="text-4xl font-bold mb-4">Кисти и малярные инструменты</h1>
            <p className="text-muted-foreground text-lg">
              Профессиональные кисти и инструменты для малярных работ
            </p>
          </div>
